...
const MethodologyDisclaimer = () => {
  return (
    <div className="mt-8 sm:mt-12 p-6 sm:p-8 bg-gray-50 rounded-lg border border-gray-200">
      <h3 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 text-black">Methodology & Scientific Basis</h3>
      
      <div className="space-y-4 sm:space-y-6 text-xs sm:text-sm text-gray-700 leading-relaxed">
        <div>
          <h4 className="text-base sm:text-lg font-semibold text-black mb-2">Individual Differences Psychology</h4>
          <p>
        ...
        <div>
          <h4 className="text-base sm:text-lg font-semibold text-black mb-2">Behavioral Genetics (Non-Deterministic Framing)</h4>
          <p>
        ...
        <div>
          <h4 className="text-base sm:text-lg font-semibold text-black mb-2">Trait Activation Theory</h4>
          <p>
        ...
        <div>
          <h4 className="text-base sm:text-lg font-semibold text-black mb-2">Self-Determination Theory (SDT)</h4>
          <p>
        ...
        <div>
          <h4 className="text-base sm:text-lg font-semibold text-black mb-2">Flow Theory</h4>
          <p>
        ...
        <div>
          <h4 className="text-base sm:text-lg font-semibold text-black mb-2">Effort Asymmetry Principle</h4>
          <p>
        ...
        <div className="pt-4 border-t border-gray-200">
          <p className="text-gray-600 italic">
            <strong className="text-gray-700">Important:</strong> This product is science-informed and diagnostic in nature. 

...
const PaywallOverlay: React.FC<PaywallOverlayProps> = ({ onUnlock, isLoading = false, buttonLabel }) => {
  return (
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
      <div className="bg-white border-2 border-gray-200 rounded-lg max-w-2xl w-full p-8 md:p-12 text-center">
        ...
        <div className="mb-8">
          ...
          <div className="text-gray-500">one-time unlock</div>
        </div>

        <button
          onClick={onUnlock}
          disabled={isLoading}
          className={`w-full px-8 py-4 bg-black text-white font-semibold rounded-lg text-lg transition-colors ${
            isLoading

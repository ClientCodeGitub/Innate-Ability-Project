...
const Footer = () => {
  return (
    <footer className="bg-gray-100 text-gray-600 py-8 sm:py-12 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
          <div className="col-span-2 sm:col-span-1">
            <h3 className="text-black font-bold text-base sm:text-lg mb-3 sm:mb-4">Innate Ability</h3>
          ...
          <div>
            <h4 className="text-black font-semibold mb-3 sm:mb-4 text-sm sm:text-base">Resources</h4>
